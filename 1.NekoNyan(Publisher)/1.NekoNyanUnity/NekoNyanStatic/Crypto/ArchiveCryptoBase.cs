...
namespace NekoNyanStatic.Crypto
{
    ...
    public abstract class ArchiveCryptoBase
    {
        /// <summary>
        /// 文件表
        /// </summary>
        ...
        public void Extract()
        {
            foreach (FileEntry entry in CollectionsMarshal.AsSpan(this.mFileEntries))
            {
                ...
                Console.WriteLine(string.Format("Extract ---> {0}/{1}", this.mPackageName, entry.FileName));
            }
        }
